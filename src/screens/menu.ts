...
export function menuScreen(go: (s: string) => void): HTMLElement {
  ...
  root.appendChild(el('div', 'subtitle', bi('Collect cards. Build your team. Win.', 'Собирай карточки. Усиливай состав. Побеждай.')));
  ...
  root.appendChild(el('div', 'stat words-stat',
